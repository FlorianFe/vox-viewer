...
import { IS_ANDROID, IS_AR_QUICKLOOK_CANDIDATE, IS_IOS, IS_IOS_CHROME, IS_IOS_SAFARI, IS_WEBXR_AR_CANDIDATE } from '@google/model-viewer/lib/constants.js';
import { $container, $renderer, $scene } from '../model-viewer-base.js';
import { enumerationDeserializer } from '@google/model-viewer/lib/styles/deserializers.js';
